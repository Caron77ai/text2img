...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/text2img)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/text2img
```

A live public deployment of this template is available at [https://text2img.templates.workers.dev](https://text2img.templates.workers.dev)
